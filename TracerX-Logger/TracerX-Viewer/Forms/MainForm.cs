...
namespace TracerX.Viewer {
    ...
    internal partial class MainForm : Form {
        ...
        public MainForm(string fileName) {
            ...
            //TEST Applying all coloring rules by default
            ColorRulesDialog.TraceLevelColors[TraceLevel.Debug].Enabled = true;
            ColorRulesDialog.TraceLevelColors[TraceLevel.Error].Enabled = true;
            ColorRulesDialog.TraceLevelColors[TraceLevel.Fatal].Enabled = true;
            ColorRulesDialog.TraceLevelColors[TraceLevel.Info].Enabled = true;
            ColorRulesDialog.TraceLevelColors[TraceLevel.Verbose].Enabled = true;
            ColorRulesDialog.TraceLevelColors[TraceLevel.Warn].Enabled = true;
